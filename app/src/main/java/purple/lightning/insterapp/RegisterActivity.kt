...
import purple.lightning.insterapp.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private var imageUri: Uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.default_profile_picture)
    ...
    private fun insertImage(username: String, encryptedPassword: String){
        ...
        ref?.putFile(imageUri!!)
            ?.addOnSuccessListener {
                ...
                val userRoom = LoggedInUsersEntity(username=username, password = encryptedPassword, isLoggedIn = true)
                ...
                val intent = Intent(this@RegisterActivity, InsterActivity::class.java)
